...
SECRET_KEY = 'rfio81n6$wac9pmhoymrb*^ps==-82b%i#oqg8#=6enol#5s7r'
...
TEMPLATE_DIRS = (
    os.path.join(PROJECT_ROOT, 'trainings/templates/'),
)
...
INSTALLED_APPS = (
    ...
    'tastypie',  # needs to be here to use ApiKeyAuthentication
    'south',
    'social_auth',
...
# more backends for auth are here
